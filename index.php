  ...
  <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">Arsip Surat <span class="logo-dec">Dinas Lingkungan Hidup Kota Cirebon</span></a>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <div class="logo">
		            <img src="img/pemerintahkotacirebon.webp" alt="" />
	            </div>
              <h3 class="bnr-sub-title">SISTEM ARSIP SURAT DINAS LINGKUNGAN HIDUP CIREBON</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">DINAS LINGKUNGAN HIDUP KOTA CIREBON</span></h3>
            </div>
          </div>
        </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">Website ini berguna untuk pengarsipan Surat Masuk dan Surat Keluar di Pemerintah Kota Cirebon</p><p>Surat diarsipkan dalam format PDF lalu disesuaikan nomor urutnya.</p>
    ...
    <section id="portfolio" class="section-padding wow fadeInUp delay-05s">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h2 class="service-title pad-bt15">Pengembang Website</h2>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
            <figure>
              <img src="img/riky.jpg" class="img-responsive">
              <figcaption>
                  <h2>RIKY MAOULANA</h2>
    ...
    <footer id="footer">
      <div class="container">
        <div class="row text-center">
          <p>&copy; RIKY MAOULANA TEKNIK INFORMATIKA </p>
          <div class="credits">
            Designed  by <a href="#">RIKY MAOULANA</a>
        </div>
        </div>
      </div>
    </footer>
